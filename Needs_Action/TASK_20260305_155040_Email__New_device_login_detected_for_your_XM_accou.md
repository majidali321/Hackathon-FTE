---
source: gmail
email_id: 19cb8c0e5aa4a75c
from: XMGlobal <site@xmglobal.com>
urgent: True
type: watcher_task
title: Email: New device login detected for your XM account
priority: high
created_at: 2026-03-05T15:50:40.590921
status: pending
watcher: GmailWatcher
---

# Email: New device login detected for your XM account

## Email Details
- **From**: XMGlobal <site@xmglobal.com>
- **Date**: Wed, 04 Mar 2026 12:09:34 +0000 (UTC)
- **Message ID**: 19cb8c0e5aa4a75c
- **Urgent**: Yes

## Email Preview
```
Security alert: check your recent sign-in New device detected Dear Valued Client, We detected a login to your XM account from an unrecognised device. Below are the details of this activity: Date and
```

## Message Body (First 500 chars)
```
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" dir="ltr" lang="en"><head><meta charset="UTF-8"><meta content="width=device-width, initial-scale=1" name="viewport"><meta name="x-apple-disable-message-reformatting"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta content="telephone=no" name="format-detection"><title></title
```
